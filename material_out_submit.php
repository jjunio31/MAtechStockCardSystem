    ...
    if ($sql_select_run){
        ...
        if ($currentQty < $issuedQty){
            ...
            if($sql_update_run){
                ...
                $sql_insert = "INSERT INTO transaction_record_tbl (TRANSACTION_DATE, GOODS_CODE, ITEM_CODE, QTY_ISSUED, TOTAL_STOCK, PART_NUMBER, PART_NAME, INVOICE_KIT) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?) ";
                $params1 = array($date, $goodsCode, $itemCode, $issuedQty, $new_total_stock, $partNumber, $partName, $invoiceKit );
